            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  SizedBox(height: 5,),
                  Center(
                    child: Text(name, style: MyTextStyle.AddVehicles,),
                  ),
                      ...
                      Expanded(
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Center(
                                child: Text('CANCEL', style: MyTextStyle.text3)),
                          ),
                        ),
                      ),
                      Expanded(
                        child: GestureDetector(
                          onTap: () {
                            ...
                            if(userNameS.text.isEmpty || scoreS.text.isEmpty) {
                              ...
                              // );
                              _instance.updateLeaderBoard(userName: userNameS.text, score: scoreS.text, gameName: selectedGameName);
                              Navigator.pop(context);
                            }
                          },
                          child: Container(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: GestureDetector(
                          onTap: () {
                            print("thish sihgt a");
                            if(gameNameG.text.isEmpty || userNameG.text.isEmpty || scoreG.text.isEmpty) {
                              showDialog(
                                  context: context,
                                  builder: (context) => AlertDialog(
                                    title: Text("Enter correct data"),
        ...
        child: Container(
          child: Column(
            children: [
              ...
              Container(
                child: Center(
                  child: Text("Update your game leaderBoard details here", style: MyTextStyle.text5,),
                ),
              ),
                    ...
                    itemBuilder: (context, index) {
                      return Container(
                        child:ExpansionTile(
                          ...
                          title: Text(
                            _instance.gamesList[index].name, style: MyTextStyle.dropdown,
                          ),
                          trailing: isExpanded
                              ? Icon(
                          ...
                          children: [
                            Column(
                                children:[
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Text("UserName", style: MyTextStyle.timing,),
                                        ...
                                        ...List.generate(_instance.gamesList[index].scoreBoard.length, (index2) {
                                          return Container(
                                            child: Row(
                                              children: [
                                                Text("#"+ "${index2+1}", style: MyTextStyle.appBarTitle,),
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(_instance.gamesList[index].scoreBoard[index2]["score"].toString(), style: MyTextStyle.referEarnText),
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      selectedGameName =_instance.gamesList[index].name;
                                      _addVehicles(size.height/3 + 70, "Add Score");
                                    },
                                    child: Container(
                                      ...
                                      child: Center(child: Text("Add Score", style: MyTextStyle.text4white,)),
                                    ),
                                  ),
                                  SizedBox(height: 20,),
                                ]
